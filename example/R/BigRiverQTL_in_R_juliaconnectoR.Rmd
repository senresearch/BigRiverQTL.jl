...
juliaLet('savefig(p, "qtl_plot.png"); println("Plot is saved.")', p = p)
```
...
```{r}
# Manhattan plots
p <- BigRiverQTL$plot_manhattan(single_results_perms, gInfo, mbColname = "Pos", size = list(800,500), dpi = 660L)
juliaLet('savefig(p, "manhattan_plot.png"); println("Plot is saved.")', p = p);
```
